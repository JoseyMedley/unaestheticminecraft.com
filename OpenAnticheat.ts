...
var illegalEntities = ["minecraft:elder_guardian_ghost", "minecraft:npc", "minecraft:agent", "minecraft:tripod_camera", "minecraft:chalkboard", "minecraft:command_block_minecart"];
    ...
    for (let i = 0; i < size; i++) {
        try {
            if (ptr.readVarUint() === 99999) {
                ...
                transferServer(ni, "uamc.us", 19132);
                return CANCEL;
            }
        } catch {}
    }
